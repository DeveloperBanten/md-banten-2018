...
Pada tampilan ini OPD dapat melihat informasi - informasi yang terdapat pada aplikasi e-Billboard seperti map dan data - data billboard yang sudah terpetakan dalam aplikasi. pada tampilan ini terdapat beberapa modul yaitu Home, Map dan Buat Laporan. Untuk mengecek dapat diakses tidaknya, user dapat mengklik menu Home, jika sudah dapat diakses user dapat ceklis pada kolom **Ada**, jika belum dapat diakses maka user dapat ceklis pada kolom **Tidak**.
...
###### 2.1.2.4.2 Log Out
Sub modul Log Out ini dapat diakses dengan mengklik tulisan Log Out pada "Nama OPD". Sub modul ini digunakan OPD untu melakukan Log Out atau keluar dari Tampilan OPD. Untuk pengujian nya *user* yang berhasil login bisa melakukan log out pada aplikasi billboard atau tidak.
...
Kolom Pencarian ini dapat diakses dengan mengetik *keyword* yang di inginkan pada kotak pencarian yang berada di kiri atas tabel billboard. Untuk pengujian nya *user* dapat mengetik keyword apa saja pada kolom pencarian, apakah data pencarian sesuai dengan kolom pencarian.
...
###### 2.1.3.2.3 Publish Billboard

Publish Billboard ini dapat diakses dengan mengklik icon gembok pada kolom action billboard. pada Publish Billboard ini superadmin dapat mengatur apakah data billboard akan dipublish atau tidak.. Untuk pengujian nya *user* dapat mengklik icon gembok apakah ada perubahan atau tidak.
...
###### 2.1.3.2.6 Delete Billboard

Delete Billboard ini dapat diakses dengan mengklik icon tong sampah pada kolom action billboard. pada Delete Billboard ini superadmin dapat menghapus data billboard. Untuk pengujian nya *user* dapat mengklik icon tong sampah pada kolom action billboard apakah ada data billboard terhapus atau tidak
...
Sub modul Log Out ini dapat diakses dengan mengklik tulisan Log Out pada Menu "Superadmin". Sub modul ini digunakan Superadmin untu melakukan Log Out atau keluar dari Tampilan Superadmin. Untuk pengujian nya *user* yang berhasil login bisa melakukan log out pada aplikasi billboard atau tidak.
